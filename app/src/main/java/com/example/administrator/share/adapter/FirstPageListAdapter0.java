...
public class FirstPageListAdapter0 extends RecyclerView.Adapter<FirstPageListAdapter0.ViewHolder>{
    ...
    public FirstPageListAdapter0(Context mContext, List<CircleListForFound> mList) {
