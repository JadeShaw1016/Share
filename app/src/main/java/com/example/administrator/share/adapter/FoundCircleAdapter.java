...
public View getView(int position, View convertView, ViewGroup parent) {
    ViewHolder holder;
    if (convertView == null) {
        convertView = inflater.inflate(R.layout.item_found_circle, null);
    ...
    // 0是女性
    if (news.getSex() == 0) {
        holder.bg.setImageResource(R.drawable.firstpage_image1);
    } else {
        holder.bg.setImageResource(R.drawable.firstpage_image2);
    }
